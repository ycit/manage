...
public class ConstantDefine {
    ...
    public static final String GOODS_IMG_PATH = "d:\\mall\\goods\\";
    public static final String GOODS_IMG_THUMBNAIL_ABSOLUTE_PATH = "thumbnail\\";
    ...
    public static final int IMG_HEIGHT = 790;
