...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.page-sidebar li.nav-item').find(".sub-menu").removeClass("hide");
        $('.page-sidebar li.' + pageId).find(".sub-menu").removeClass("hide");
    });
</script>
...
<div class="page-sidebar navbar-collapse collapse">
    ...
    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
        ...
        <li class="nav-item user-manager">
            ...
            <ul class="sub-menu">
                <li class="nav-item">
                    <a href="#task/predState" class="nav-link">
                        <span aria-hidden="true" class="icon-users"></span>
                        <span class="title">态势预测</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#task/hotanalysis" class="nav-link">
                        <span aria-hidden="true" class="icon-users"></span>
                        <span class="title">热点分析</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#task/predEvalution" class="nav-link">
                        <span aria-hidden="true" class="icon-users"></span>
                        <span class="title">预测评估</span>
                    </a>
                </li>
            </ul>
        </li>
