...
<div class="page-content" style="min-height:1318px">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" value="系统监控定时邮件任务" name="groupName">
                                    <div class="col-md-9">
                                        <select name="groupId" class="form-control">
                                            <option value="1">系统监控任务</option>
                                        </select>
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div style="margin-top: 6px">
                                            <input type="radio" checked name="status" value="0">开启&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="status" value="1">关闭
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <content tag="page_script">
        ...
        <script src="${ctx}/static/back/js/custom/component/component-add.js" type="text/javascript"></script>
    </content>
