...
<div class="page-content" style="min-height:1318px">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input name="fullName" type="text" class="form-control" value="${dept.fullName}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input name="nickname" type="text" class="form-control" value="${dept.nickname}">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input name="level" type="text" class="form-control" value="${dept.level}">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="pId" value="${dept.pId}" id="dept-id">
                                    <div class="col-md-9">
                                        <input id="dept-input" readonly="readonly" name="pIdName" type="text" class="form-control" value="<c:if test='${dept.parentDept == null}'>— —</c:if><c:if test='${dept.parentDept != null}'>${dept.parentDept.fullName}</c:if>">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
    ...
    <content tag="page_script">
        ...
        <script src="${ctx}/static/back/js/custom/dept/dept-edit.js" type="text/javascript"></script>
    </content>
