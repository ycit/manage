...
<div class="page-content" style="min-height:1318px">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input id="dept-input" readonly="readonly" name="deptName" type="text" class="form-control" placeholder="">
                                        <span class="help-block"></span>
                                    </div>
                                </div>
                            </div>
    ...
    <content tag="page_script">
        ...
        <script src="${ctx}/static/back/js/custom/job/job-add.js" type="text/javascript"></script>
    </content>
