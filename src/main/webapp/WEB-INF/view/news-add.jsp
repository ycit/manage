...
<div class="page-content" style="min-height:1318px">
            ...
            <form id="news-form" class="form-horizontal" role="form" enctype="multipart/form-data">
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="news-url" name="url" class="form-control" placeholder="输入资讯对应链接">
                        </div>
                    </div>
                </div>
    ...
    <content tag="page_script">
        <script src="${ctx}/static/back/js/custom/news/news-add.js" type="text/javascript"></script>
    </content>
